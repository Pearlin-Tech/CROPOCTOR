...
export const COUNTRIES: CountryConfig[] = [
  { code: 'IN', name: 'India',                flag: '🇮🇳', languages: ['hi','en'], defaultLanguage: 'hi', units: { area: 'acres',    temperature: 'celsius'    }, currency: 'INR', timezone: 'Asia/Kolkata'        },
  { code: 'BR', name: 'Brazil',               flag: '🇧🇷', languages: ['pt-BR','en'], defaultLanguage: 'pt-BR', units: { area: 'hectares', temperature: 'celsius'    }, currency: 'BRL', timezone: 'America/Sao_Paulo'   },
  ...
  { code: 'CN', name: 'China',                flag: '🇨🇳', languages: ['zh-CN','en'], defaultLanguage: 'zh-CN', units: { area: 'hectares', temperature: 'celsius'    }, currency: 'CNY', timezone: 'Asia/Shanghai'        },
